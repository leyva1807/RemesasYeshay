                    ...
                    <div class="login__right bg--light">
                        ...
                        <div class="tab-content mt-4" id="nav-tabContent">
                            <form class="login__form row g-3 g-sm-4 verify-gcaptcha" action="{{ route('user.register') }}" autocomplete="off" method="POST">
                                ...
                                <div class="col-sm-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control checkUser form--control" id="email" name="email" type="email" value="{{ old('email') }}" required>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control form--control checkUser" name="mobile" type="number" value="{{ old('mobile') }}">
                                        </div>
                                ...
                                <div class="col-sm-6 col-xl-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group hover-input-popup">
                                            ...
                                            <input class="form-control form--control border-end-0 @if ($general->secure_password) secure-password @endif" name="password" type="password" />
                                ...
                                @if ($general->agree)
                                    <div class="form-group">
                                        <input name="agree" type="checkbox" @checked(old('agree')) required>
