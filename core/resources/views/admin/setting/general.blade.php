                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="user_send_money_limit" type="number" value="{{ getAmount($general->user_send_money_limit) }}" min="0" step="any">
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="user_daily_send_money_limit" type="number" value="{{ getAmount($general->user_daily_send_money_limit) }}" min="0" step="any">
                                        <span class="input-group-text">{{ $general->cur_text }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="user_monthly_send_money_limit" type="number" value="{{ getAmount($general->user_monthly_send_money_limit) }}" min="0" step="any">
                                        <span class="input-group-text">{{ $general->cur_text }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" name="agent_send_money_limit" type="number" value="{{ getAmount($general->agent_send_money_limit) }}" min="0" step="any">
                                            <span class="input-group-text">{{ $general->cur_text }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" name="agent_daily_send_money_limit" type="number" value="{{ getAmount($general->agent_daily_send_money_limit) }}" min="0" step="any">
                                            <span class="input-group-text">{{ $general->cur_text }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" name="agent_monthly_send_money_limit" type="number" value="{{ getAmount($general->agent_monthly_send_money_limit) }}" min="0" step="any">
                                            <span class="input-group-text">{{ $general->cur_text }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" name="agent_charges[fixed_charge]" type="number" value="{{ getAmount(@$general->agent_charges->fixed_charge) }}" min="0" step="any">
                                ...
                                <div class="col-xl-4 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" name="agent_charges[percent_charge]" type="number" value="{{ getAmount(@$general->agent_charges->percent_charge) }}" min="0" step="any">
                                            <div class="input-group-text cur_text">
                                                %
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" name="agent_fixed_commission" type="number" value="{{ getAmount($general->agent_fixed_commission) }}" min="0" step="any">
                                            <div class="input-group-text cur_text">
                                                {{ $general->cur_text }}
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" name="agent_percent_commission" type="number" value="{{ getAmount($general->agent_percent_commission) }}" min="0" step="any">
                                            <span class="input-group-text">
                                                %
                                            </span>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="referral_commission" type="number" value="{{ getAmount($general->referral_commission) }}" min="0" step="any">
                                        <span class="input-group-text">
                                            %
                                        </span>
                                    </div>
