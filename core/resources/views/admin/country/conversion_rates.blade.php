                            ...
                            <div class="col-lg-6 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" name="data[{{ $loop->index }}][rate]" type="number" value="{{ $value }}" step="any">
...
@push('breadcrumb-plugins')
    <button class="btn btn-sm btn-outline--primary confirmationBtn" data-question="@lang('To sync successfully via the API, ensure the conversion rate API is configured. Are you sure you want to proceed with this currency conversion synchronization?')" data-action="{{ route('admin.country.currency.conversion.synchronize', $country->id) }}">
