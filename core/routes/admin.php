...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function () {
        ...
        Route::post('send-push', 'sendPushNotification')->name('send.push.notification');
    });

    //country
    Route::prefix('country')->group(function () {
        Route::controller('CountryController')->name('country.')->group(function () {
            ...
            Route::post('currency/conversion-synchronize/{id}', 'synchronizeViaApi')->name('currency.conversion.synchronize');
        });
        Route::controller('ServiceController')->name('service.')->prefix('delivery-method')->group(function () {
        ...
        Route::controller('ConversionRateController')->name('conversion.rate.api.')->prefix('conversion-rate-api')->group(function () {
            Route::get('/', 'index')->name('index');
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function () {
        ...
        Route::get('send-push-notification', 'showPushNotificationAll')->name('notification.push.all');
        Route::post('send-push-notification', 'sendPushNotificationAll')->name('notification.push.all.send');
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        Route::post('maintenance-mode', 'maintenanceModeSubmit');
         ...
         //firebase setting
         Route::get('firebase-setting', 'firebaseSetting')->name('setting.firebase');
         Route::post('firebase-setting', 'firebaseSettingUpdate');
    });
